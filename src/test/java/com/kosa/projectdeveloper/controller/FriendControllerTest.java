...
//
//    final FriendReviewAddResponse userRequest = new FriendReviewAddResponse(title, content);
//
...
//
//        FriendUpdateRequest request = new FriendUpdateRequest(newTitle, newContent);
//
