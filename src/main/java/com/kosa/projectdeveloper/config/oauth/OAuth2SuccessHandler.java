...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public static final String REDIRECT_PATH = "/updateUser";
    ...
    private void saveRefreshToken(Long tokenId, String newRefreshToken) {
        RefreshToken refreshToken = refreshTokenRepository.findByTokenId(tokenId)
                .map(entity -> entity.update(newRefreshToken))
                .orElse(new RefreshToken(tokenId, newRefreshToken));
